...
export default function FAQ() {
  ...
  return (
    <section className="relative py-24 sm:py-32 overflow-hidden">
      {/* Background - transparent to match site */}
      <div className="absolute top-0 left-1/4 w-[600px] h-[600px] bg-[#38BDF8] rounded-full blur-[200px] opacity-[0.03]" />
      <div className="absolute bottom-0 right-1/4 w-[500px] h-[500px] bg-[#A855F7] rounded-full blur-[200px] opacity-[0.03]" />
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mt-12">
          <a
            ...
            className="group relative inline-flex items-center gap-3 px-8 py-4 rounded-2xl font-semibold text-white overflow-hidden transition-all duration-300 hover:scale-105 hover:shadow-2xl hover:shadow-[#38BDF8]/25"
          >
            {/* Gradient Background */}
            <div className="absolute inset-0 bg-gradient-to-r from-[#38BDF8] to-[#A855F7]" />
            
            {/* Shine Effect */}
            <div className="absolute inset-0 bg-gradient-to-r from-transparent via-white/20 to-transparent -translate-x-full group-hover:translate-x-full transition-transform duration-700" />
            
            {/* Border Glow */}
            <div className="absolute -inset-[2px] bg-gradient-to-r from-[#38BDF8] to-[#A855F7] rounded-2xl blur opacity-40 group-hover:opacity-70 transition-opacity duration-300" />
